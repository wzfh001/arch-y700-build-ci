...
expected_ignore='IgnorePkg = noctalia wvkbd paru tb321fu-imported-release-payload tb321fu-camera-stack tb321fu-wifi-firmware tb321fu-zen-browser tb321fu-cc-switch tb321fu-mihomo-party tb321fu-codex-cli'
