...
expected_ignore='IgnorePkg = noctalia wvkbd paru tb321fu-imported-release-payload qcom-sns-libssc qcom-sns-iio-sensor-proxy tb321fu-camera-stack tb321fu-wifi-firmware tb321fu-bluetooth-firmware tb321fu-alsa-ucm tb321fu-zen-browser tb321fu-cc-switch tb321fu-mihomo-party tb321fu-codex-cli'
