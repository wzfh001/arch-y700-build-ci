...
export ROOTFS_RAW_SHA="${ROOTFS_RAW_SHA:-c4efa7ce73ef33ff63551992a56b0e82c115e965d74e5ec7f7345fbb2a2e98a8}"
export GRUB_RAW_SHA="${GRUB_RAW_SHA:-7378dc11fd597890e4130f9f62f607828086ef9c9cd4395169c566f437ff41cc}"
export DATE="$now"
