...
export ROOTFS_RAW_SHA="${ROOTFS_RAW_SHA:-3a472fbca5ac591794ea238d27225029836919f9c23215db16ba562956d78ae2}"
export GRUB_RAW_SHA="${GRUB_RAW_SHA:-f54035fd298b6f81ad7a26893b6007e3e7b62a03372899f8b49573be2ba09945}"
export DATE="$now"
