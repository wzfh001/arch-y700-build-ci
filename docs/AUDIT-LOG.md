...
| `DEV-20260802-003` | bundle completion | run 30736975180 KDE Firehose bundle (Wi-Fi fix d1d3c1d): 19 members, readback 10/10 from KDE raw 3a472fbc | PASS (local checksum 19/19, known-gpt/firehose identical to verified baseline) |
