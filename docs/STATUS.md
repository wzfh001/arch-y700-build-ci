...
| P7 First-boot rescue & network | **VERIFIED-PARTIAL** | Wi-Fi scan/connect/DHCP VERIFIED @192.168.0.156; support bundle collected; USB ACM/NCM + BT NAP PARTIAL (physical Type-C/peer needed) |
