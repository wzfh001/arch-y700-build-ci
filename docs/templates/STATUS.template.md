...
- The **Arch rootfs pipeline** builds successfully (artifact-only) but the
  current candidate has **not passed the full offline audit (P4 @P4_STATUS@)** and
...
| P4 Candidate offline audit | **@P4_STATUS@** | Main ZIP not fully downloaded; `AUDIT-20260723-001` remains `PARTIAL/BLOCKED` |
