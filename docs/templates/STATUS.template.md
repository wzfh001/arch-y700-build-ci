...
| P7 First-boot rescue & network | **@P7_STATUS@** | Wi-Fi scan/connect/DHCP VERIFIED @192.168.0.156; support bundle collected; **BT NAP removed (2026-08-02 user decision)**; dnsmasq retained for USB rescue `shared`; USB ACM/NCM still needs physical Type-C partner |
